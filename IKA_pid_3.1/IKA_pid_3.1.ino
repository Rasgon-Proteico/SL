...
int izq;
int der;
float KP = .79;              //.049  A 40 BASE; 0.088 a 45; 0.098 a 50
float KI = 0.0015;          //0.0067 A 40 BASE;  0.0068 a 45; 0.0082 a 50
float KD = 1.46;           //0.0085 a 45; 0.0144 a 50;
...
void loop() {
  ...
  if(digitalRead(go)==0){
      ...
      ///////////
    setESC(1050); // Ajusta la velocidad (1000 = mínimo, 2000 = máximo)
    delay(20);
    ////////////
