...
void setMotor(int pwmPin, int dir1, int dir2, int speed) {
     ...
     Serial.print(pwmPin);
      ...
      int ain2 = 4;
      int ain1 = 5;
      int stby = 6;               //Mantener esta configuracion si es el de sin turbina
      int bin1 = 7;
      int bin2 = 8;
      int pwmb = 9;           // Change to pin 11 if use the Alan´s code
...
speedA y speedB son las velocidades de los motores que se ajustan en función de la salida del PID. Si la salida es positiva, el robot girará a la izquierda, si es negativa, girará a la derecha. Si la salida es 0, el robot irá recto.
Constrain de velocidades:
